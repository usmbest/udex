...
const messages = defineMessages({
  ...
  exchangeLaws: {
    ...
    defaultMessage: ' To adhere to international securities and exchange laws, UDEX prohibits use of this platform by US residents. By using this platform, you are confirming that you are not excluded from use by this criteria.',
  },
  tokenListing: {
  ...
  loginMethods: {
    ...
    defaultMessage: 'Log in to UDEX to trade',
  },
  obyteapp: {

...
class FaqPage extends React.PureComponent {
  render() {
    ...
    return (
      <DocumentTitle title="FAQ | UDEX">
        <Spring from={{ opacity: 0 }} to={{ opacity: 1 }}>
        {props => 
        <Container style={props}>
          <h1>UDEX Knowledge Base</h1>
          <FaqGrid>
            <FirstColumn>
            <FaqItem
              question="What is UDEX ?"
              match={match}
            >
              UDEX is a community-owned marketplace and decentralized exchange built on the Obyte DAG.
              UDEX trades are settled directly between the two exchanging parties without any intermediates. We do not 
              hold any funds and have no ability to do so. With UDEX, you can trade any Obyte token whether they
            ...
            <Box p={2} />
            <FaqItem
              question="How is UDEX different from an exchange like Binance or Coinbase ?"
              match={match}
            >
              Unlike custodial and centralized exchanges, UDEX team does not hold any funds nor secret keys. You can deposit and withdraw
            ...
            <Box p={2} />
            <FaqItem
              question="How do I setup an UDEX account?"
              match={match}
            >
              Getting started with trading on UDEX is easy! If you do not currently have an Obyte wallet, you 
            ...
            <Box p={2} />
            <FaqItem
              question="Do I need a pre-existing Obyte wallet to use UDEX ?"
              match={match}
            >
            ...
            <FaqItem
              ...
              match={match}
            >
              Once you logged in to your UDEX account, you need to deposit some Bytes and/or tokens in order to trade. Click the "Deposit" button on your Wallet page, enter the amount you want to deposit, and your Obyte wallet will open with a prefilled payment, which you need to confirm.<br/><br/>
            ...
            <Box p={2} />
            <FaqItem
              question="How fast is UDEX ?"
              match={match}
            >
              While UDEX is a decentralized exchange, it is as fast as its centralized counterparts:
              <FaqList>
                <FaqListItem>
                ...
                <FaqListItem>
                  2) When you your order is matched, the results of the trade are immediately reflected on the exchange and you can immediately withdraw the tokens you just bought. The trade is later (in a few minutes) committed to the DAG when UDEX sends the two matching orders to the Autonomous Agent of the exchange. At this moment, the trade becomes irreversible.
                </FaqListItem>
                <FaqListItem>
            ...
            <FaqItem
              ...
              match={match}
            >
              No, contrary to some other decentralized exchange protocols, you do not need any additional tokens (other than Bytes which are necessary to pay for network fees on Obyte) to trade on UDEX.
            </FaqItem>
            <Box p={2} />
            <FaqItem
              question="Is UDEX fully decentralized ?"
              match={match}
            >
              UDEX is a hybrid decentralized exchange. We maintain the orderbook and match orders with each other. Trades are then settled on the Obyte chain.
            ...
            <FaqItem
              ...
              match={match}
            >
              No. Contrary to most decentralized exchanges, making and canceling orders on UDEX is free. You only pay the trade fee
            ...
            <FaqItem
              ...
              match={match}
            >
              The UDEX matching-engine matches orders fast. When your order is matched, the corresponding trade is sent to a queue that will settle the trade
            ...
            <Box p={2} />
            <FaqItem
              question="How does UDEX secure my funds ?"
              match={match}
            >
            ...
            <Box p={2} />
            <FaqItem
              question="I forgot which address I used to log in to UDEX"
              match={match}
            >

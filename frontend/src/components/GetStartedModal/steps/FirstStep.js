  ...
  return (
    <React.Fragment>
      <ModalBody>
        ...
        <p>• UDEX is an open-source decentralized cryptocurrency exchange for Obyte tokens.</p>
        ...
        <p>
          • Trades performed on UDEX are immediately settled on the Obyte DAG. For better performance and UX,
          the orderbook is kept off-chain and can be shared by multiple exchanges built on UDEX technology.
        </p>
        ...
        <p>• Verify that you are on https://usm.best everytime you log in</p>
        ...
        <br />
        <Header>❔ Ask for help or join the UDEX community</Header>
        <p>• If you have any suggestions, or want to get involved with the project, join us on <a href={DISCORD_URL}>Obyte Discord</a> in #udex channel.</p>
        <br />
        </ModalText>
      </ModalBody>
      <ModalFooter>
  ...
  return (
    <React.Fragment>
      <ModalBody>
        <ModalText>
          <Callout>
            The latest news on everything UDEX
          </Callout>
          <br />
          <Link url={MEDIUM_URLS.USMDEX_INTRODUCTION}>
            <Header>🛸 Quick Introduction to the UDEX decentralized exchange</Header>
          </Link>
          <p>A quick introduction to the UDEX decentralized and everything you can do with it.</p>
    ...
    <React.Fragment>
      <ModalBody>
        <ModalText>
          ...
          <br />
          <Header>What happens when I deposit my coins to UDEX ?</Header>
          <p>Your coins are stored on UDEX Autonomous Agent and you can withdraw them at any time. Nobody but you has access to these coins, only you can send orders to exchange one token for another. </p>
          <br />
        </ModalText>
      </ModalBody>
      <ModalFooter>

...
// other UDEX instances (only if our node is light)
...
exports.deviceName = 'UDEX Wallet';
...
exports.mongoDbName = process.env.testnet ? 'udex_test' : 'udex';
...
console.log('finished udex conf');
